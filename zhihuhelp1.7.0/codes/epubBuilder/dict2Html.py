    ...
    def contentTrans(self):
        for question in self.questionList:
            ...
            if question['kind'] == 'article':
                contentHeader['titleImage'] = '<div class="duokan-image-single"><img src="{}" alt=""/></div>'.format(
                    question['titleLogo'])
            else:
            ...
            for answer in question['answerList']:
                ...
                for key in ['authorLogo', 'authorName', 'authorSign', 'content', 'agreeCount', 'commentCount',
                            'updateDate']:
                    contentHeader[key] = ''
            ...
            # fileName
            # fileContent
            buf = {'fileName': str(question['questionID']), 'contentName': question['title'],
