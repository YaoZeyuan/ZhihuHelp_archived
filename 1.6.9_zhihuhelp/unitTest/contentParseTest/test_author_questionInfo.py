...
from correct_author_questionInfo import checkList
...
class MyTestCase(unittest.TestCase):
    ...
    """
    def setUp(self):
        targetFilePath = "../htmlFile/{target}Content/{target}1.html".format(target = "author")
        content = open(targetFilePath, "r").read()
